...
def get_claude_system_prompt():
  ...
  return f"""You are a CLI command interpreter for the Coderush engineering metrics tool. Convert natural language input into specific commands.
...
def parse_command(command_str: str) -> tuple[CommandType, list, Optional[TimeRange]]:
  ...
  if not parts: # In case of empty command, it should start chat
...
2. Install the Coderush GitHub App
...
#   completion_scripts = {
#     "bash": """
# # Coderush CLI bash completion
# eval "$(_CODERUSH_CLI_COMPLETE=bash_source coderush-cli)"
# """,
#     "zsh": """
# # Coderush CLI zsh completion
# eval "$(_CODERUSH_CLI_COMPLETE=zsh_source coderush-cli)"
# """,
#     "fish": """
# # Coderush CLI fish completion
# eval (env _CODERUSH_CLI_COMPLETE=fish_source coderush-cli)
# """,
#   }
#
#   console.print(
